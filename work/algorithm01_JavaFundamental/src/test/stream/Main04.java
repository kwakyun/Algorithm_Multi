...
public class Main04 {
    public static void main(String[] args) {
        ...
        System.out.println(list.stream().mapToDouble((x)->x).min().getAsDouble()); //OptionalDouble [1.1]
        System.out.println(list.stream().mapToDouble((x)->x).max().getAsDouble()); //OptionalDouble [1.1]
